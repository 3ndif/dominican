...
<article class="col-md-9 offers-content">
    <div class="col-md-12 personal-profile clear">
        ...
        <div class="col-md-8">
            ...
            @if ($user->isCurrent())
            <div class="submit-advertisement col-md-6">
                <a href="#">
                    <i class="fa fa-bullhorn" aria-hidden="true"></i>Подать обьявление
                </a>
            </div>
            <div class="advertising-site col-md-6">
                <a href="#">
                    <i class="fa fa-arrow-circle-up" aria-hidden="true"></i>реклама на сайте
                </a>
            </div>
            @endif
        </div>
